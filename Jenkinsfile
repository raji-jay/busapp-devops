pipeline {
    ...
    stages {
        stage('Clone') {
            steps {
                git 'https://github.com/raji-jay/busapp.git'
            }
        }
        ...
        stage('Docker Build & Push') {
            steps {
                ...
                withCredentials([usernamePassword(credentialsId: 'dockerhub-creds', usernameVariable: 'DOCKER_HUB_USER', passwordVariable: 'DOCKER_PASSWORD')]) {
